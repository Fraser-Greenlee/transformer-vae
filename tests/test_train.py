...
class TrainTests(TestCasePlus):
    ...
    def test_train_funnel_t5_critic(self):
        stream_handler = logging.StreamHandler(sys.stdout)
        logger.addHandler(stream_handler)
    ...
    def test_train_funnel_t5_smooth(self):
        stream_handler = logging.StreamHandler(sys.stdout)
        logger.addHandler(stream_handler)
    ...
    def test_train_funnel_t5_extra_encoder_block(self):
        stream_handler = logging.StreamHandler(sys.stdout)
        logger.addHandler(stream_handler)
    ...
    def test_train_funnel_t5_cycle_loss(self):
        stream_handler = logging.StreamHandler(sys.stdout)
        logger.addHandler(stream_handler)
